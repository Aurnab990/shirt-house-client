        ...
        <div>
            <div className="carousel w-full">
                <div id="slide1" className="carousel-item relative w-full">
                    <img src="https://img2.10bestmedia.com/static/img/placeholder-shopping.jpg" className="w-full blur-sm -translate-y-6" />
                    ...
                    <div className="bg-red-950 absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <h1 className='text-8xl text-white p-3 font-bold'>
                            This is <br></br>
                            Our Product
